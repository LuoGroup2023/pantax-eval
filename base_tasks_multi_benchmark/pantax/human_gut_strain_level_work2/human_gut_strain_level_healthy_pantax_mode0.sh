...
read=/home/work/gyli/real_human_gut/ont/SRR18490940_alignment_rmhost.fastq.gz
genome_length=-
...
if [ ! -f $strain_abundance ]; then
    ...
    if [ $need_create == "False" ]; then
        ...
        /usr/bin/time -v -o create_db_time.log $pantax -f $database_genomes_info -l -r $read --create --mode 1 -t $threads $zip_paras --debug
