...
db='-'
db=/home/work/wenhai/metaprofiling/bacteria_refgenome_NCBIdata/multi_species_single_strain_zymo/long_alternative_methods/metamaps/prepare/databases/strain_level_metamaps_db
