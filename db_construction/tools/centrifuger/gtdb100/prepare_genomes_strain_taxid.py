...
def main():
    ...
    prepare_bacteria_genomes_for_centrifuge(genomes_info_file, genome2strain_taxid_file)
    reference_strains = get_ref(genomes_info_file, genome2strain_taxid_file)
    parallel_map(reference_strains)

def prepare_bacteria_genomes_for_centrifuge(genomes_info_file, genome2strain_taxid_file):
